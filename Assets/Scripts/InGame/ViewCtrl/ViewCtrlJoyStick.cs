...
public class JoyStick : MonoBehaviour, IPointerDownHandler, IDragHandler, IPointerUpHandler
{
    ...
    void Awake()
    {
        ...
        var canvasGo = GameObject.Find("GameBoot/UIRoot");
    ...
    public void OnPointerDown(PointerEventData eventData)
    {
        ...
        {
            Vector2 pos;
            RectTransformUtility.ScreenPointToLocalPointInRectangle(_joystickRt, eventData.position, _uiCamera, out pos);

            _dotParentRt.anchoredPosition = pos;//ConvertUtils.ScreenPoint2UILocalPoint(_joystickRt, eventData.position);
        }
        OnDrag(eventData);
    }
