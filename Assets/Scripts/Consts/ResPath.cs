namespace Game
{
    ...
    {
        public static readonly string prefabPath_wood = "GameRes/Prefabs/Wood";

        public static readonly string prefabPath_StartPanel = "GameRes/Prefabs/UIpanels/StartPanel";
